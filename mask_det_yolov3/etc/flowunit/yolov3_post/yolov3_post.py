...
import json
import numpy as np
from yolov3_utils import Yolov3

class yolov3_postFlowUnit(modelbox.FlowUnit):
    ...
    def process(self, data_context):
        ...
        for buffer_feat1, buffer_feat2, buffer_feat3 in zip(input_feat1, input_feat2, input_feat3):
            ...
            bboxes = self.yolov3.get_result(feats)
